{
    ...
    // ```tsx
    // // 함수 정의
    const add = function (a: number | string, b: number | string): number | string {
...

{
    ...
    // ```tsx
    // 함수 정의
    const concatStringAndNumber = function (str1: string, str2: string | number): string {
...

{
    ...
    // ```tsx
    // // 함수 정의
    const greet = function (str1: string, str2?: string): string {
        if (str2) {
            return `${str2}, ${str1}!`
        } else {
            return `Welcome, ${str1}!`
